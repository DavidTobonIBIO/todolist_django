...
urlpatterns = [
    ...
    path('lists/<int:list_id>/share/', task_list_views.share_list, name='share-list'),
    path('lists/<int:list_id>/unshare/<int:user_id>/', task_list_views.unshare_list, name='unshare-list'),
]